...
def load_model():
    ...
    Implemented by: Yash Vashisth (2301730158)
    """
...
def generate_post(topic, generator):
    ...
    Author: Yash Vashisth (2301730158)
    """
    import re
...
def main():
    ...
    Developed by: Yash Vashisth (2301730158)
    """
    
    # Header
    st.markdown('<h1 class="main-header">🚀 Social Media Content Generator</h1>', 
                unsafe_allow_html=True)
    st.markdown('<p class="sub-header">Powered by AI | Developed by Yash Vashisth (2301730158)</p>', 
                unsafe_allow_html=True)
    
    # Sidebar
    with st.sidebar:
        st.header("📋 Project Information")
        st.write("**Developer:** Yash Vashisth")
        ...
        if topic:
            with st.spinner("🤖 AI is generating your content... Please wait."):
                try:
                    ...
                    # Footer
                    st.divider()
                    st.caption("Content generated by AI | Created by Yash Vashisth (2301730158)")
